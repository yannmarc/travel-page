...
const GuideSection = () => {
  return (
    <Fragment>
            ...
            <div className="main-container lg:max-w-[1100px] lg:mx-auto px-6 xl:px-0 flex flex-col lg:flex-row lg:flex lg:items-center gap-x-8">
                <div className="text">
                    <Headline 
                    subHeading={"SERVICES"}
                ...
                <div className="cards-section lg:w-[1050px] lg:absolute lg:right-[-152px]">
